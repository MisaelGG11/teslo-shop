...
export const SideBard = () => {
  return (
    <>
      <div className="fixed top-0 left-0 w-screen h-screen bg-[#00000070] backdrop-blur-sm z-10" />

      <aside className="fixed right-0 top-0 w-72 h-screen bg-white shadow-lg z-20 p-4 transform transition-transform duration-300 ease-in-out">
        <IoCloseOutline
